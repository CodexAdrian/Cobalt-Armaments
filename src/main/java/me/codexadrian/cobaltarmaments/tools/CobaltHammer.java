...
public class CobaltHammer extends PickaxeItem implements CobaltTool {


    public CobaltHammer(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
