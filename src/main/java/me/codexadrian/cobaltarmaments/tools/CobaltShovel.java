...
public class CobaltShovel extends ShovelItem implements CobaltTool {

    public CobaltShovel(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
