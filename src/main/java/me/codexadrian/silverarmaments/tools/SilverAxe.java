...
public class SilverAxe extends AxeItem implements SilverTool {

    public SilverAxe(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        return SilverArmaments.getIfEmpowered(stack) ? SilverTool.super.veinMine(stack, world, state, BlockTags.LOGS, pos, miner) : this.attemptEnergyDrain(stack, 1);
    }
