...
public class SilverPickaxe extends PickaxeItem implements SilverTool {
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        if(state.getBlock() instanceof OreBlock) {
            return SilverArmaments.getIfEmpowered(stack) ? SilverTool.super.veinMine(stack, world, state, pos, miner) : this.attemptEnergyDrain(stack, 1);
        }
